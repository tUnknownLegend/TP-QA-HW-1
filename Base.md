...
- Название товара
   <kbd>
     <img src="/images/item-review-title.png" alt="Название товара">
   </kbd>
 ...
 - Отзывы
   <kbd>
     <img src="/images/review-read.png" alt="Отзыв">
   </kbd>
...
- Название товара
   <kbd>
     <img src="/images/item-write-review-description.png" alt="Название товара">
   </kbd>
 ...
 -  При попытке отправить строки с целью эксплуатации XSS угрозы, отзыв оформлется, но потенциально вредностные символы в отзыв не попадают

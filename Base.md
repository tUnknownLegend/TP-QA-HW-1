...
![item-write-review-description](https://user-images.githubusercontent.com/57019979/221988092-e0abc056-30d1-4321-b99c-d40a190695c7.png)
 ...
 - Выбор рейтинга
    - Цвездочки загораются при наведении курсора, если рейтинг не выбран. Если рейтинг выбран, то данное поведение будет сохраняться только для более высокого рейтинга, чем выбран ранее. 
 ...
 - *Некорректное поведение.* Нарушается плавность рендра. Вначале рендрится страница, затем карточки товаров
...
- Поисковая строка
  - Для отправки поискового запроса требуется ввести 3 и более симовла

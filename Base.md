...
- Поисковая строка
  - Для отпраки посикгового запроса требуется ввести 3 и более симовла
  - Допускаются латинские и кираиллические буквы, цифры и символы !?()_./-
  - Если поисковой запрос содержит другие символы или менее 3 символов, то появляется соответсвующее сообщение

...
![item-write-review-description](https://user-images.githubusercontent.com/57019979/221988092-e0abc056-30d1-4321-b99c-d40a190695c7.png)
 ...
 -  Ограничений на символы нет, но есть ограничение по длинне текста в каждом поле в 300 символов
 ...
 - *Некорректное поведение.* Нарушается плавность рендеринга. Вначале рендрится страница, затем карточки товаров
...
- Поисковая строка
  - Для отправки поискового запроса требуется ввести 3 и более симоволоы
